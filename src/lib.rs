...
//!
//! This crate provides a wrapper around the [`notify`] crate to allow
//! integration with the [`calloop`] event loop. To get started, just create a
//! [`NotifySource`] and insert it into your event loop.
//!
//! ## Example
//!
//! ```rust,no_run
